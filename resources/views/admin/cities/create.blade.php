...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Создать локацию</div>
                    <div class="card-body">
                        ...
                        {!! Form::open(['url' =>  route('admin.cities.store'), 'class' => 'form-horizontal', 'files' => true]) !!}
                            <div class="tab-content">
                                @include ('admin.cities.form', ['formMode' => 'create', 'prefix' => 'ru_', 'name' => 'На русском', 'show' => 'active' ])

                                @include ('admin.cities.form', ['formMode' => 'create', 'prefix' => 'en_', 'name' => 'На английском', 'show' => null ])
                            </div>
                        {!! Form::close() !!}
