...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Создать портфолио</div>
                    <div class="card-body" data-form>
                        ...
                        {!! Form::open(['url' =>  route('admin.projects.store'), 'class' => 'form-horizontal', 'files' => true]) !!}

                            <div class="tab-content">
                                @include ('admin.projects.form', ['formMode' => 'create', 'prefix' => 'ru_', 'name' => 'На русском', 'show' => 'active' ])

                                @include ('admin.projects.form', ['formMode' => 'create', 'prefix' => 'en_', 'name' => 'На английском', 'show' => null ])
                            </div>
                        {!! Form::close() !!}
