        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(['method' => 'GET', 'url' => route('admin.activitylogs.index'), 'class' => 'form-inline my-2 my-lg-0 float-right', 'role' => 'search'])  !!}
                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($activitylogs as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->causer)
                                                <a href="{{ url('/adminka/users/' . $item->causer->id) }}">{{ $item->causer->name }}</a>
                                            @else
                                                -
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            {!! Form::open([
                                                'method' => 'DELETE',
                                                'url' => [route('admin.activitylogs.destroy', $item->id)],
